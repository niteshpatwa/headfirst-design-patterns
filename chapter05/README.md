...
- Singleton pattern for ChocolateBoiler, ensuring only one instance controls chocolate-making process.

![alt text](../resources/5.1.png)

## Project 2: Classic
- Classic Singleton Design Pattern Example
- Basic Singleton implementation with private constructor and static getInstance().

![alt text](../resources/5.2.png)

## Project 3: MultiThread
- Multithreaded Singleton Design Pattern Example
- Thread-safe Singleton using synchronized getInstance() to handle concurrent access.
